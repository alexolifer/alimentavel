(function ($) {
    ...
    // :: SLIDE IN AND OUT DO MENU DE LOGIN

    $('.form-structor').on('click', function (event) {
    ...
    $('.login').click( function() {
        ...
        setTimeout( function() { 
            ...
            $('#login-container').css('background-color','rgba(0,0,0,0.5)');
    ...
    $('#login-container').click( function() {
        ...
        $('#login-container').css('background-color','rgba(0,0,0,0)');
